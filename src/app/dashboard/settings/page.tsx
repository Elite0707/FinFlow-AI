  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <Tabs defaultValue="general" className="w-full">
        <TabsList className="mb-8 w-full justify-start border-b rounded-none h-auto p-0 bg-transparent space-x-6">
          <TabsTrigger 
            value="general" 
        ...
        <TabsContent value="notifications" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label>Extraction Completed</Label>
                  <p className="text-sm text-muted-foreground">Get notified when a document finishes processing.</p>
                </div>
                <Switch checked={true} />
              </div>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Receive alerts about credit usage and invoices.</p>
                </div>
                <Switch checked={true} />
              </div>
              <div className="flex items-center justify-between">
