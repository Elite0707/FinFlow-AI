...
import { FileText, Calendar, Files, CheckCircle2 } from "lucide-react";
        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="sm:max-w-2xl h-[80vh] flex flex-col p-0 gap-0">
                ...
                <div className="flex-1 overflow-hidden flex flex-col">
                    <Tabs defaultValue="batches" className="flex-1 flex flex-col overflow-hidden" onValueChange={setActiveTab}>
